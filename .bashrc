...
HISTSIZE=10000000
HISTFILESIZE=1000000 #Infinite History
...
#getpaper() { curl -O $(curl -s http://sci-hub.tw/"$@" | grep location.href | grep -o http.*pdf) ; }


# Alias definitions. 
# You may want to put all your additions into a separate file like
# ~/.aliasesrc, instead of adding them here directly.
# See /usr/share/doc/bash-doc/examples in the bash-doc package.
# for the moment all aliases will be here...
if [ -f ~/.aliasrc ]; then
    . ~/.aliasrc
fi
